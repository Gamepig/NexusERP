#!/usr/bin/env python3
"""
Fix chart rendering by ensuring proper canvas dimensions and initialization
"""
...
async def fix_and_test_charts():
    ...
    async with async_playwright() as p:
        ...
        try:
            print("🚀 Starting Chart Rendering Fix")
            ...
            print("🔧 Applying Chart Rendering Fixes...")
            ...
            # Fix 2: Destroy existing charts and recreate them properly
            await page.evaluate("""
            ...
            # Fix 3: Create charts with proper error handling
            await page.evaluate("""
                console.log('[Fix] Creating charts with proper initialization...');
                ...
                try {
                    ...
                    if (inventoryCtx) {
                        ...
                        const inventoryChart = new Chart(inventoryCtx, {
                            type: 'bar',
                            data: {
                                labels: ['筆記型電腦', '印表機', '螢幕', '鍵盤', '滑鼠', '耳機', 'USB', '記憶卡', '硬碟', '主機板'],
                                datasets: [{
                                    label: '庫存量',
                    ...
                    console.log('[Fix] All charts created successfully!');
                    
                } catch (error) {
                    console.error('[Fix] Chart creation error:', error);
                }
            """)
            ...
            screenshot_path = "/Users/gamepig/projects/NexusERP/frontend/dashboard_fixed_charts.png"
            ...
            if working_charts == 3:
                print("✅ All charts are now working properly!")
                return True
            else:
                print("⚠️  Some charts still need fixes")
                return False
